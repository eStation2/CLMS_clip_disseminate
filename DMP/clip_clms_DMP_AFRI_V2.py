...
def run_dmp_afri_clipping(filepathname):
    ...
    clip_all_vars_netcdf4(filepathname, output_file, origin_lat=origin_lat, origin_lon=origin_lon, clip_width=desired_width, clip_height=desired_height, data_vars = ['DMP', 'LENGTH_AFTER', 'LENGTH_BEFORE', 'NOBS', 'QFLAG', 'RMSE'], identifier=identifier, parent_identifier=parent_identifier)
