...
def run_fapar_afri_clipping(filepathname, dir_out="/home/eouser/clms/outputs/afr/"):
    ...
    identifier = 'urn:cgls:africa:fapar300_v1_333m:'+var_name+'300-RT0_'+date_str+'_AFRI_OLCI_'+version
    parent_identifier = 'urn:cgls:africa:fapar300_v1_333m'
    ...
    clip_all_vars_netcdf4(filepathname, output_file, origin_lat=origin_lat, origin_lon=origin_lon, clip_width=desired_width, clip_height=desired_height, data_vars = ['FAPAR', 'LENGTH_AFTER', 'LENGTH_BEFORE', 'NOBS', 'QFLAG', 'RMSE'], identifier=identifier, parent_identifier=parent_identifier)
    ...
    ##### XML ####
    destination_xml = os.path.join(directory_name,"c_gls_"+var_name+"300-RT0_PROD-DESC_"+date_str+"_AFRI_OLCI_"+version+".xml")
    ...
    xml_file_path = os.path.join(dir_in, "CGLS_"+var_name+"300_V1_S3_ProductSet_PDF.xml" )
