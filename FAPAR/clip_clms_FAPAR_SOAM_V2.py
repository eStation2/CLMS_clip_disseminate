...
def clip_all_vars_netcdf4(input_nc_file, output_nc_file, lat_range=None, lon_range=None,
    ...
    Optimized for large c_gls_FAPAR300 datasets.
    """
    try:
...
def run_fapar_soam_clipping(filepathname, dir_out="/home/eouser/clms/outputs/sam/"):
    ...
    identifier = f'urn:cgls:south-america:fapar300_{v_num}_333m:{var_name}300-RT0_{date_str}_SOAM_OLCI_{version}'
    parent_identifier = f'urn:cgls:south-america:fapar300_{v_num}_333m'
    ...
    return clip_and_package(
        ...
        data_vars=["FAPAR", "LENGTH_AFTER", "LENGTH_BEFORE", "NOBS", "QFLAG", "RMSE"],
        identifier=identifier,
        parent_identifier=parent_identifier,
        color_table=os.path.join(dir_in, "cgl_colorTable_FAPAR.txt"),
