...
def clip_all_vars_netcdf4(input_nc_file, output_nc_file, lat_range=None, lon_range=None,
    ...
    Optimized for large c_gls_NDVI300 datasets.
    """
    try:
...
def main_modify_XML(date_str, ql_filename, destination_xml, xml_file_path):
    ...
    params_dict = {
        "identifier": "urn:cgls:continents:ndvi300_v3_333m:NDVI300_"+date_str+"_SOAM_OLCI_V3.0.1",
        "parent_identifier": "urn:cgls:continents:ndvi300_v3_333m",
        ...
        "alternate_title": "NDVI300_"+date_str+"_SOAM_OLCI_V3.0.1",
...
def run_ndvi_soam_clipping(filepathname, dir_out="/home/eouser/clms/outputs/sam/"):
    ...
    identifier = 'urn:cgls:continents:ndvi300_v3_333m:' + var_name + '300_' + date_str + '_SOAM_OLCI_' + version
    parent_identifier = 'urn:cgls:continents:ndvi300_v3_333m'
    destination_xml = os.path.join(dir_out, date_str[0:8], "c_gls_NDVI300_PROD-DESC_" + date_str + "_SOAM_OLCI_V3.0.1.xml")
    xml_file_path = os.path.join(dir_in, "CGLS_NDVI300_V2_S3_ProductSet_PDF_SOAM.xml")
    color_table = os.path.join(dir_in, "ColorTable_NDVI300_V2.txt")
    ...
    return clip_and_package(
        ...
        data_vars=['NDVI', 'NDVI_unc', 'LENGTH_BEFORE', 'NOBS', 'QFLAG'],
        ...
        xml_modifier_args=[xml_file_path],
    )
...
if __name__ == "__main__":
    ...
    try:
        final_path = run_ndvi_soam_clipping(filepathname)
        print(final_path)
        sys.exit(0)
    except Exception as e:
