...
def main_modify_XML(date_str, ql_filename, destination_xml, xml_file_path):
    ...
    params_dict = {
        "identifier": "urn:cgls:continents:ndvi300_v3_333m:NDVI300_" + date_str + "_AFRI_OLCI_V3.0.1",
        ...
        "alternate_title": "NDVI300_" + date_str + "_AFRI_OLCI_V3.0.1",
...
# if __name__ == "__main__":
def run_ndvi_afri_clipping(filepathname, dir_out="/home/eouser/clms/outputs/afr/"):
    ...
    identifier = 'urn:cgls:continents:ndvi300_v3_333m:' + var_name + '300_' + date_str + '_AFRI_OLCI_' + version
    parent_identifier = 'urn:cgls:continents:ndvi300_v3_333m'
    destination_xml = os.path.join(dir_out, date_str[0:8], "c_gls_NDVI300_PROD-DESC_" + date_str + "_AFRI_OLCI_V3.0.1.xml")
