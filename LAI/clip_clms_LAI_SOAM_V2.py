...
def clip_all_vars_netcdf4(input_nc_file, output_nc_file, lat_range=None, lon_range=None,
    ...
    Optimized for large c_gls_LAI300 datasets.
    """
    try:
...
def run_lai_soam_clipping(filepathname, dir_out="/home/eouser/clms/outputs/sam/"):
    ...
    identifier = f'urn:cgls:south-america:lai300_{v_num}_333m:{var_name}300-RT0_{date_str}_SOAM_OLCI_{version}'
    parent_identifier = f'urn:cgls:south-america:lai300_{v_num}_333m'
    ...
    return clip_and_package(
        ...
        data_vars=["LAI", "LENGTH_AFTER", "LENGTH_BEFORE", "NOBS", "QFLAG", "RMSE"],
        identifier=identifier,
        parent_identifier=parent_identifier,
        color_table=os.path.join(dir_in, "cgl_colorTable_LAI.txt"),
...
if __name__ == "__main__":
    ...
    try:
        final_path = run_lai_soam_clipping(filepathname)
        print(final_path)
        sys.exit(0)
    except Exception as e:
